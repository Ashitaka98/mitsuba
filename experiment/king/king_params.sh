...
do
    ...
    do
        mkdir -p /home/lzr/layeredBsdfData/meta_texture/1108001/king/alpha0_${alpha_0}_alphpa1_${alpha_1}; \
        python /home/lzr/layeredBsdfModel/meta_texture_maker_batch.py --GPU=1 \
            ...
            --out_dir=/home/lzr/layeredBsdfData/meta_texture/1108001/king/alpha0_${alpha_0}_alpha1_${alpha_1} \
            --sh_dim=81 \
