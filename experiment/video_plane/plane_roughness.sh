...
source activate
sampleCount=64
for alpha_1 in 'seq 0.005 0.1'; do
    for sigmat in ; do
        ...
        mkdir -p /home/lzr/Projects/mitsuba/experiment/video_plane/output/sigmat
        /home/lzr/Projects/mitsuba/dist/mitsuba /home/lzr/Projects/mitsuba/experiment/video_plane/plane.xml \
            ...
            -D eta1=1.5 \
            -o /home/lzr/Projects/mitsuba/experiment/video_plane/output/sigmat/roughness_${alpha_1}_sigmat_${sigmat}_$sampleCount.exr
    done
done